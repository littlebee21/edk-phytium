...
{
  return readb (KEYBOARD_8042_DATA_REGISTER);
}
...
{
  writeb (Data, KEYBOARD_8042_DATA_REGISTER);
}
...
{
  return readb (KEYBOARD_8042_STATUS_REGISTER);
}
...
{
  writeb (Data, KEYBOARD_8042_COMMAND_REGISTER);
}
