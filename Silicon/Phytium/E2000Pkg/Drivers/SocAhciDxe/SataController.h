...
#ifndef _SOC_SATA_CONTROLLER_H_
#define _SOC_SATA_CONTROLLER_H_
...
//
#define SOC_SATA_CONTROLLER_SIGNATURE SIGNATURE_32 ('P','S','A','T')
...
#define SATA_CONTROLLER_PRIVATE_DATA_FROM_THIS(a) CR(a, EFI_SATA_CONTROLLER_PRIVATE_DATA, IdeInit, SOC_SATA_CONTROLLER_SIGNATURE)
